    ...
    return (
        <div className="px-6 pt-[28px]">
            <div className='flex items-center justify-between mb-[18px]'>
                <div className='font-w-700 text-[20px] leading-[28px]'>{content.general.your_games}</div>
                <ButtonSeeAll>{content.general.butSeeAllLabel}</ButtonSeeAll>
            </div>
            <div>
                {games && (
                    games.map((game, index) => (
                        <div key={index} className='bg-blue-900 rounded-[16px] mb-[19px] py-[13px] px-[32px]'>
                            ...
                            <div className='text-[14px] leading-[20px] font-w-500 text-green-200'>{content.general.position} {game.position}#</div>
