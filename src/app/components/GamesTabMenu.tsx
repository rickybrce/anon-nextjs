...
const GamesTabMenu = ({ items, active, activeName}: Props) => {
  ...
  return (
    <div className="text-center">
      <div
        className={`w-full lg:w-auto lg:min-w-[635px] w-auto inline-block gradient-border-menu relative mt-[27px] transition-all duration-500 bg-blue-600 border-green-100 mx-auto rounded-[16px] px-0 py-[9px] relative`}
      >
